...
const ThemeDarkIcon = styled("i")(({ theme }) => ({
	...
	transform: theme.palette.mode === "dark" ? "rotate(0deg) scale(1)" : "rotate(360deg) scale(0.5)",
	position: "absolute",
	display: "block",
}));
...
const DarkLightIconButton = ({ onClickFunction }) => {
	...
	return (
		<ToggleThemeAppearanceIconButton disableRipple disableTouchRipple disableFocusRipple onClick={onClickFunction}>
			<ThemeIconContainer>
				<ThemeLightIcon>
