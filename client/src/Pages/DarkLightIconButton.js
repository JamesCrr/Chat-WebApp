...
const ThemeLightIcon = styled("i")(({ theme }) => ({
	...
	transform: theme.palette.mode === "light" ? "rotate(0deg) scale(1.3)" : "rotate(180deg) scale(0.5)",
	position: "absolute",
	display: "block",

	[theme.breakpoints.down("md")]: {
		transform: theme.palette.mode === "light" ? "rotate(0deg) scale(1.0)" : "rotate(180deg) scale(0.5)",
	},
}));
...
const DarkLightIconButton = ({ onClickFunction }) => {
	const theme = useTheme();

	return (
		<ToggleThemeAppearanceIconButton onClick={onClickFunction}>
			<ThemeIconContainer>
				<ThemeLightIcon>
...
export default DarkLightIconButton;
